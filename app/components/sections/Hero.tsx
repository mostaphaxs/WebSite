        ...
        <div className="lg:col-span-8 flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-8">
            ...
            <motion.div style={{ y: yText }}>
              <h1 className="text-7xl md:text-[9.5rem] font-black uppercase tracking-tighter leading-[0.8] italic text-zinc-900">
                L'âme <br /> 
                <span className="text-zinc-200">Des Espaces</span>
              </h1>
              <p className="mt-8 max-w-lg text-zinc-400 font-medium tracking-wide uppercase text-[10px] leading-relaxed">
